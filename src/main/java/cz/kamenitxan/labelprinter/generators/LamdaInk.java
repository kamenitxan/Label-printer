...
public class LamdaInk extends PdfGenerator {
    ...
    private static final float lamdaImageWidth = 77;
    private static final float lamdaImageHeight = 167;
    private static final float labelImageWidth = 15;
    private static final float labelImageHeight = 82;
